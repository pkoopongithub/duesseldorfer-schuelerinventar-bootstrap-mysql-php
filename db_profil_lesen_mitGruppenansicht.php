...
<table width="75%" border="0" cellspacing="0" cellpadding="5"  >
  <tr>
    ...
    <p><? if (!$druckansicht){echo("<a href=http://mein-duesk.org/db_druckansicht.php?ID=$ID&userID=$userID&session=$session&normtabelle=$normtabelle&druckansicht=1 target=_blank>Druckansicht</a><BR><a href=http://mein-duesk.org/db_zeitreihe.php?ID=$ID&userID=$userID&groupId=$groupId&session=$session&normtabelle=$normtabelle&druckansicht=1 target=_blank>Gruppenansicht Selbsteinsch&auml;tzung</a>");}?></p>
    <p>Name: <? echo(" ".$name); ?>
	</p>
...
<circle cx="<? echo(" ".$FEprofilSVG[5]*50+125);  ?>" cy="234" r="10" stroke="blue"; stroke-width="5" fill="white" />
         ...
         <div class="panel panel-default">
           <div class="panel-heading">
            <h3 class="panel-title">Korrelation / &Uuml;bereinstimmung</h3>
           </div>
...
if ($korrelation >= 0.8) {
    echo "<br>Die Fremdeinsch&auml;tzung und Selbsteinsch&auml;tzung weisen eine starke Korrelation auf.<br>";
} elseif ($korrelation >= 0.5) {
    echo "<br>Die Fremdeinsch&auml;tzung und Selbsteinsch&auml;tzung weisen eine moderate Korrelation auf.<br>";
} elseif ($korrelation >= 0.3) {
    echo "<br>Die Fremdeinsch&auml;tzung und Selbsteinsch&auml;tzung weisen eine schwache Korrelation auf.<br>";
} else {
    echo "<br>Die Fremdeinsch&auml;tzung und Selbsteinsch&auml;tzung weisen keine signifikante Korrelation auf.<br>";
}

      ?>
      </p>
      <p>Von der Korrelation unabh&auml;ngige &Uuml;bereinstimmung der Rohwerte <? echo(" ".round($UebereinstimmungSEFE,2)."%"); ?>
	  </p>
      <?
...
echo "<br>Selbsteinsch&auml;tzung im Verh&auml;ltnis zur Vergleichsgruppe:<br>";
$aussagen = array(
    "Arbeitsverhalten" => array(
        0 => "Du sch&auml;tzt dein Arbeitsverhalten als weit unterdurchschnittlich ein.",
        1 => "Du sch&auml;tzt dein Arbeitsverhalten als unterdurchschnittlich ein.",
        2 => "Du sch&auml;tzt dein Arbeitsverhalten als durchschnittlich ein.",
        3 => "Du sch&auml;tzt dein Arbeitsverhalten als &uuml;berdurchschnittlich ein.",
        4 => "Du sch&auml;tzt dein Arbeitsverhalten als weit &uuml;berdurchschnittlich ein."
    ),
    "Lernverhalten" => array(
        0 => "Du sch&auml;tzt dein Lernverhalten als weit unterdurchschnittlich ein.",
         1 => "Du sch&auml;tzt dein Lernverhalten als unterdurchschnittlich ein.",
        2 => "Du sch&auml;tzt dein Lernverhalten als durchschnittlich ein.",
        3 => "Du sch&auml;tzt dein Lernverhalten als &uuml;berdurchschnittlich ein.",
        4 => "Du sch&auml;tzt dein Lernverhalten als weit &uuml;berdurchschnittlich ein."
    ),
    "Sozialverhalten" => array(
        0 => "Du sch&auml;tzt dein Sozialverhalten als weit unterdurchschnittlich ein.",
         1 => "Du sch&auml;tzt dein Sozialverhalten als unterdurchschnittlich ein.",
        2 => "Du sch&auml;tzt dein Sozialverhalten als durchschnittlich ein.",
        3 => "Du sch&auml;tzt dein Sozialverhalten als &uuml;berdurchschnittlich ein.",
        4 => "Du sch&auml;tzt dein Sozialverhalten als weit &uuml;berdurchschnittlich ein."
    ),
    "Fachkompetenz" => array(
        0 => "Du sch&auml;tzt deine Fachkompetenz als weit unterdurchschnittlich ein.",
         1 => "Du sch&auml;tzt deine Fachkompetenz als unterdurchschnittlich ein.",
        2 => "Du sch&auml;tzt deine Fachkompetenz als durchschnittlich ein.",
        3 => "Du sch&auml;tzt deine Fachkompetenz als &uuml;berdurchschnittlich ein.",
        4 => "Du sch&auml;tzt deine Fachkompetenz als weit &uuml;berdurchschnittlich ein."
    ),
    "Personale Kompetenz" => array(
        0 => "Du sch&auml;tzt deine personale Kompetenz als weit unterdurchschnittlich ein.",
         1 => "Du sch&auml;tzt deine personale Kompetenz als unterdurchschnittlich ein.",
        2 => "Du sch&auml;tzt deine personale Kompetenz als durchschnittlich ein.",
        3 => "Du sch&auml;tzt deine personale Kompetenz als &uuml;berdurchschnittlich ein.",
        4 => "Du sch&auml;tzt deine personale Kompetenz als weit &uuml;berdurchschnittlich ein."
    ),
    "Methodenkompetenz" => array(
        0 => "Du sch&auml;tzt deine Methodenkompetenz als weit unterdurchschnittlich ein.",
         1 => "Du sch&auml;tzt deine Methodenkompetenz als unterdurchschnittlich ein.",
        2 => "Du sch&auml;tzt deine Methodenkompetenz als durchschnittlich ein.",
        3 => "Du sch&auml;tzt deine Methodenkompetenz als &uuml;berdurchschnittlich ein.",
        4 => "Du sch&auml;tzt deine Methodenkompetenz als weit &uuml;berdurchschnittlich ein."
    )
);
...
// Umgangssprachliche Auswertung
echo "<br><br> Fremdeinsch&auml;tzung im Verh&auml;ltnis zur Vergleichsgruppe: <br>";
$aussagen = array(
    "Arbeitsverhalten" => array(
        0 => "Dein Arbeitsverhalten wird als weit unterdurchschnittlich eingesch&auml;tzt.",
        1 => "Dein Arbeitsverhalten wird als unterdurchschnittlich eingesch&auml;tzt.",
        2 => "Dein Arbeitsverhalten wird als durchschnittlich eingesch&auml;tzt.",
        3 => "Dein Arbeitsverhalten wird als &uuml;berdurchschnittlich eingesch&auml;tzt.",
        4 => "Dein Arbeitsverhalten wird als weit &uuml;berdurchschnittlich eingesch&auml;tzt."
    ),
    "Lernverhalten" => array(
        0 => "Dein Lernverhalten wird als weit unterdurchschnittlich eingesch&auml;tzt.",
        1 => "Dein Lernverhalten wird als unterdurchschnittlich eingesch&auml;tzt.",
        2 => "Dein Lernverhalten wird als durchschnittlich eingesch&auml;tzt.",
        3 => "Dein Lernverhalten wird als &uuml;berdurchschnittlich eingesch&auml;tzt.",
        4 => "Dein Lernverhalten wird als weit &uuml;berdurchschnittlich eingesch&auml;tzt."
    ),
    "Sozialverhalten" => array(
        0 => "Dein Sozialverhalten wird als weit unterdurchschnittlich eingesch&auml;tzt.",
        1 => "Dein Sozialverhalten wird als unterdurchschnittlich eingesch&auml;tzt.",
        2 => "Dein Sozialverhalten wird als durchschnittlich eingesch&auml;tzt.",
        3 => "Dein Sozialverhalten wird als &uuml;berdurchschnittlich eingesch&auml;tzt.",
        4 => "Dein Sozialverhalten wird als weit &uuml;berdurchschnittlich eingesch&auml;tzt."
    ),
    "Fachkompetenz" => array(
        0 => "Deine Fachkompetenz wird als weit unterdurchschnittlich eingesch&auml;tzt.",
        1 => "Deine Fachkompetenz wird als unterdurchschnittlich eingesch&auml;tzt.",
        2 => "Deine Fachkompetenz wird als durchschnittlich eingesch&auml;tzt.",
        3 => "Deine Fachkompetenz wird als &uuml;berdurchschnittlich eingesch&auml;tzt.",
        4 => "Deine Fachkompetenz wird als weit &uuml;berdurchschnittlich eingesch&auml;tzt."
    ),
    "Personale Kompetenz" => array(
        0 => "Deine personale Kompetenz wird als weit unterdurchschnittlich eingesch&auml;tzt.",
        1 => "Deine personale Kompetenz wird als unterdurchschnittlich eingesch&auml;tzt.",
        2 => "Deine personale Kompetenz wird als durchschnittlich eingesch&auml;tzt.",
        3 => "Deine personale Kompetenz wird als &uuml;berdurchschnittlich eingesch&auml;tzt.",
        4 => "Deine personale Kompetenz wird als weit &uuml;berdurchschnittlich eingesch&auml;tzt."
    ),
    "Methodenkompetenz" => array(
        0 => "Deine Methodenkompetenz wird als weit unterdurchschnittlich eingesch&auml;tzt.",
        1 => "Deine Methodenkompetenz wird als unterdurchschnittlich eingesch&auml;tzt.",
        2 => "Deine Methodenkompetenz wird als durchschnittlich eingesch&auml;tzt.",
        3 => "Deine Methodenkompetenz wird als &uuml;berdurchschnittlich eingesch&auml;tzt.",
        4 => "Deine Methodenkompetenz wird als weit &uuml;berdurchschnittlich eingesch&auml;tzt."
    ),
);
...
echo "<br><br>";
if ($korrelation >= 0.8) {
    echo "Die Fremdeinsch&auml;tzung und Selbsteinsch&auml;tzung weisen eine starke Korrelation auf.\n";
} elseif ($korrelation >= 0.5) {
    echo "Die Fremdeinsch&auml;tzung und Selbsteinsch&auml;tzung weisen eine moderate Korrelation auf.\n";
} elseif ($korrelation >= 0.3) {
    echo "Die Fremdeinsch&auml;tzung und Selbsteinsch&auml;tzung weisen eine schwache Korrelation auf.\n";
} else {
    echo "Die Fremdeinsch&auml;tzung und Selbsteinsch&auml;tzung weisen keine signifikante Korrelation auf.\n";
}

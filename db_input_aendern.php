...
?>
        ...
        <div class="panel panel-default">
           <div class="panel-heading">
            <h3 class="panel-title">Rohdatenblatt Ändern</h3>
           </div>
...
<form method="post" action="<? echo("$PHP_SELF"); ?>">
 ...
 <input name="namegruppe" type="text" class="form-control" size="30" maxlength="40" >
  ...
  <table class="table table-hover" width="48%" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolor="#C0C0C0">
    ...
    <tr>
      <td>Zuverl&auml;ssigkeit:<br><br>Ich beachte beim Erfüllen eines Auftrags 
    ...
    <tr>
      <td>Organisationsf&auml;higkeit:<br><br>Ich mache Vorschläge zur 
    ...
    <tr>
      <td>Konzentrationsf&auml;higkeit:<br><br>Ich kann eine Tätigkeit über 
	  längere Zeit ausüben, ohne mich ablenken zu lassen.</td>
      <td><div align="center"> 
    ...
    <tr>
	  ...
	  und übernehme auch die Verantwortung für sie.</td>
      <td><div align="center"> 
    ...
    <tr>
	  ...
	  sie auch ohne Anstoß von außen.</td>
      <td><div align="center"> 
    ...
    <tr>
      <td>Leistungsbereitschaft:<br><br>Ich arbeite auch über das geforderte Maß 
    ...
    <tr>
      <td>Auffassungsgabe:<br><br>Ich kann Zusammenhänge leicht und schnell 
	  begreifen.</td>
      <td><div align="center"> 
    ...
    <tr>
      <td>Merkf&auml;higkeit:<br><br>Einmal Gelerntes weiß ich nach längerer 
	  Zeit noch.</td>
      <td><div align="center"> 
    ...
    <tr>
      <td>Teamf&auml;higkeit:<br><br>Ich kann zielgerichtet und förderlich mit 
    ...
    <tr>
      <td>Hilfsbereitschaft:<br><br>Wenn jemand Unterstützung braucht, bin ich 
    ...
    <tr>
	  ...
	  deren Vorschlägen interessiert.</td>
      <td><div align="center"> 
    ...
    <tr>
      <td>Respektvoller Umgang:<br><br>Ich beachte die Formen der Höflichkeit im 
    ...
    <tr>
      <td>Kommunikationsf&auml;higkeit:<br><br>Ich gehe auf Fragen ein und höre 
    ...
    <tr>
	  ...
	  gemeinsame Lösung zu finden.</td>
      <td><div align="center"> 
    ...
    <tr>
      <td>Naturwissenschaft:<br><br>Ich interessiere mich für die Natur und ihre 
	  Gesetze.</td>
      <td><div align="center"> 
    ...
    <tr>
      <td>Fremdsprachen:<br><br>Ich kann mich in einer Fremdsprache ausdrückken.</td>
      <td><div align="center"> 
    ...
    <tr>
      <td>Pr&auml;sentationsf&auml;higkeit:<br><br>Wenn ich präsentiere, hören 
    ...
    <tr>
      <td>PC Kenntnisse:<br><br>Ich kann den PC für die schulische Arbeit 
	  nutzen.</td>
      <td><div align="center"> 
    ...
    <tr>
	  ...
	  erworben habe, auch in anderen Zusammenhängen anwenden.</td>
      <td><div align="center"> 
...
<form method="post" action="<? echo("$PHP_SELF"); ?>">
 ...
 <input type=hidden name=navi value=1>
  <input type=hidden name=userID value=<? echo $userID ?>>
 <input type=hidden name=session value=<? echo $session ?>>
 <button name="einfuegen" value="einfuegen" type="submit" class="btn btn-default">einfügen</button>
